...
dic_feat = {'Kids_money': [['X1', 'X2', 'X3'], ['X64', 'X65', 'X66'], ['X169', 'X170', 'X171']],
            ...
            'Home_money': [['X36', 'X37', 'X38'], ['X43', 'X44', 'X45'], ['X71', 'X72', 'X73'],
                           ['X120', 'X121', 'X122'], ['X134', 'X135', 'X136'],
                           ['X141', 'X142', 'X143'], ['X183', 'X184', 'X185'], ['X232', 'X233', 'X234']],
            'Home_number': [['X40', 'X41', 'X42'], ['X47', 'X48', 'X49'], ['X75', 'X76', 'X77'],
                            ['X124', 'X125', 'X126'], ['X138', 'X139', 'X140'],
            ...
            'Other_money': [['X92', 'X93', 'X94'], ['X99', 'X100', 'X101'], ['X106', 'X107', 'X108'],
                            ['X148', 'X149', 'X150'], ['X78', 'X79', 'X80'],
                            ['X155', 'X156', 'X157'], ['X176', 'X177', 'X178'], ['X218', 'X219', 'X220'],
                            ['X239', 'X240', 'X241'],
                            ['X29', 'X30', 'X31']],
            'Other_number': [['X96', 'X97', 'X98'], ['X103', 'X104', 'X105'], ['X110', 'X111', 'X112'],
                             ['X152', 'X153', 'X154'], ['X82', 'X83', 'X84'],
                             ['X159', 'X160', 'X161'], ['X180', 'X181', 'X182'], ['X222', 'X223', 'X224'],
                             ['X243', 'X244', 'X245'],
                             ['X33', 'X34', 'X35']],
            'Transport_money': [['X113', 'X114', 'X115'], ['X127', 'X128', 'X129'], ['X190', 'X191', 'X192'],
                                ['X197', 'X198', 'X199'],
                                ['X204', 'X205', 'X206']],
            'Transport_number': [['X117', 'X118', 'X119'], ['X131', 'X132', 'X133'], ['X194', 'X195', 'X196'],
                                 ['X201', 'X202', 'X203'],
                                 ['X208', 'X209', 'X210']],
            'Insurance_money': [['X211', 'X212', 'X213']],
            'Insurance_number': [['X215', 'X216', 'X217']],
            'Allowance_money': [['X246', 'X247', 'X248'], ['X253', 'X254', 'X255'], ['X260', 'X261', 'X262'],
                                ['X274', 'X275', 'X276']],
            'Allowance_number': [['X250', 'X251', 'X252'], ['X267', 'X258', 'X259'], ['X264', 'X265', 'X266'],
                                 ['X278', 'X279', 'X280']],
...
def make_feats(df, method, prop):
    if method == 'old':
        ...
        for new_feat, old_feats in dic_feat.items():
            if new_feat != 'All_prop_money' and new_feat != 'All_prop_number':
        ...
        if prop:
            for col in new_df:
                if 'Allowance_money' in col or 'Earnings_money' in col or 'Allowance_number' in col or 'Earnings_number' in col:
                    new_df[col] /= REC[:, int(col[-1])]
                elif 'All_prop_money' not in col and 'All_prop_number' not in col:
